      ...
      >
        ...
        <div class="relative z-10 flex justify-center items-center w-full">
          <div class="container mx-auto flex items-center justify-center">
            <div class="w-full lg:w-3/4 p-6 lg:p-10 mx-auto lg:h-[500px] border-[1px] flex flex-col justify-center rounded shadow-xl mt-10 bg-white/70 dark:bg-gray-800 dark:border-gray-900 backdrop-blur-lg dark:backdrop-blur-none">
      ...
      <div class="lg:py-20 max-sm:mt-40" id="services">
        <div class="container mx-auto w-full lg:w-3/4">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 max-sm:mt-40">
            <div class="bg-[#f9f6f0] dark:bg-gray-800 inset-shadow rounded-lg">
              <div class="bg-[#f9f6f0] dark:bg-gray-900 py-6 px-4">
